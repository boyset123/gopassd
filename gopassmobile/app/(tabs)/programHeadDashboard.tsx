...
import { View, Text, StyleSheet, ScrollView, Pressable, ActivityIndicator, Alert, Platform, Image, ImageBackground, Modal, TouchableOpacity, TextInput, RefreshControl } from 'react-native';
